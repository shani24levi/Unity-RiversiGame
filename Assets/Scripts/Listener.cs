...
namespace AssemblyCSharp
{
	...
	{						
		...
		//my add
		public delegate void UserLeaveRoomHandler(RoomData eventObj, string _UserName);
		public static event UserLeaveRoomHandler OnUserLeftRoom;

		public delegate void UserRoomDestroyedHandler(RoomData eventObj);
		public static event UserRoomDestroyedHandler OnRoomDestroyed;
